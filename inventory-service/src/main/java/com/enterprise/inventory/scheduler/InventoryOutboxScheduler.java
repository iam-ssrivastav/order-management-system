package com.enterprise.inventory.scheduler;

import com.enterprise.inventory.entity.OutboxEvent;
import com.enterprise.inventory.repository.OutboxRepository;
...
public class InventoryOutboxScheduler {
    ...
    private static final Logger log = LoggerFactory.getLogger(InventoryOutboxScheduler.class);

    private final OutboxRepository outboxRepository;
    private final KafkaTemplate<String, Object> kafkaTemplate;
    private final ObjectMapper objectMapper;

    public InventoryOutboxScheduler(OutboxRepository outboxRepository, KafkaTemplate<String, Object> kafkaTemplate,
